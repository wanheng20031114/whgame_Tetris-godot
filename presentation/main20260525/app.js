const translations = {
  "zh-CN": {
    ...
    "cover_download": "下载",
    "cover_label": "中文核心文档",
    "cover_version": "2026-05-25 · 留档（已弃用）",
  ...
  "ja": {
    ...
    "cover_version": "2026-05-25 · アーカイブ（非推奨）",
    ...
    "origin_h2": "きっかけ：上達したいプレイヤーほど、使いやすい学習ツールの少なさに気づきます。",
  ...
  "en": {
    ...
    "cover_version": "2026-05-25 · Archive (Deprecated)",
